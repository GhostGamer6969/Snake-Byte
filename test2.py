...
class SNAKE:
    def __init__(self):
        ...
        self.tail_left = pygame.image.load('./asset/tail_left.png').convert_alpha()
...
class STARTMENU:
    def __init__(self):
        ...
        self.play_button = Button("Play", (cell_number * cell_size // 2 - 50, cell_number * cell_size // 2 - 100), 30)
        self.easy_button = Button("Easy", (cell_number * cell_size // 2 - 50, cell_number * cell_size // 2 - 50), 30)
        self.medium_button = Button("Medium", (cell_number * cell_size // 2 - 50, cell_number * cell_size // 2), 30)
        self.hard_button = Button("Hard", (cell_number * cell_size // 2 - 50, cell_number * cell_size // 2 + 50), 30)
        self.quit_button = Button("Quit", (cell_number * cell_size // 2 - 50, cell_number * cell_size // 2 + 100), 30)

    def draw_start_menu(self):
        self.play_button.show(screen)
        self.easy_button.show(screen)
        self.medium_button.show(screen)
        self.hard_button.show(screen)
        self.quit_button.show(screen)

    def handle_event(self, event):
        if self.play_button.click(event) and self.selected_level:
            self.start = False
...
while True:
    ...
    if start_menu.start:
        ...
        if start_menu.selected_level == 'easy':
            game_speed = 200
        elif start_menu.selected_level == 'medium':
            game_speed = 150
        elif start_menu.selected_level == 'hard':
            game_speed = 100
